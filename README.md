...
### Implement an algorithm to determine if a string has all unique characters.
  ...
  2. [O(n) time complexity and O(1) space complexity for a-z input only](https://github.com/1rosehip/JavaScript-Algorithm-Questions/blob/master/determine-if-a-string-has-all-unique-characters-2.js) / [Codepen](https://codepen.io/1rosehip/pen/vrWgeq)
